...
from examples.NIPS.MNIST.noisy_sequence_detection.noisy_scenarios.scenario110_2.generate_data import \
    get_initiated_at_scenario110
...
def make_audio_scenario110_for_window(window):
...
if __name__ == '__main__':
    make_audio_scenario110_for_window(1)
