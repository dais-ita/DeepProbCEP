...
initiatedAt(sequence0 = true, T) :-
    ...
    sequenceEndingAt([0, 0], Remaining, T).
initiatedAt(sequence0 = false, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([1, 1], Remaining, T).

initiatedAt(sequence1 = true, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([2, 2], Remaining, T).
initiatedAt(sequence1 = false, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([3, 3], Remaining, T).

initiatedAt(sequence2 = true, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([4, 4], Remaining, T).
initiatedAt(sequence2 = false, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([5, 5], Remaining, T).

initiatedAt(sequence3 = true, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([6, 6], Remaining, T).
initiatedAt(sequence3 = false, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([7, 7], Remaining, T).

initiatedAt(sequence4 = true, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([8, 8], Remaining, T).
initiatedAt(sequence4 = false, T) :-
    givenRemaining(Remaining),
    sequenceEndingAt([9, 9], Remaining, T).
